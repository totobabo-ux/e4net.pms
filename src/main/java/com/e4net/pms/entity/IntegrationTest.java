...
public class IntegrationTest {
    ...
    @Column(name = "integration_test_id", length = 100)
    private String integrationTestId;     // 통합테스트ID (예: TTD-PMS-001)

    @Column(name = "integration_test_name", nullable = false, length = 200)
