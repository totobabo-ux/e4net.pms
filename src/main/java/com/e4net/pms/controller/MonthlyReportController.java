...
public class MonthlyReportController {
    ...
    public String createForm(HttpSession session, Model model) {
        ...
        dto.setReportType("월간보고");
        dto.setReportName("월간보고");    // 보고서명 초기값
    ...
    public String create(@ModelAttribute("report") CustomerReportDto dto,
        ...
        dto.setReportType("월간보고");    // 보고구분 강제 고정
        customerReportService.save(dto, attachFile);
        redirectAttributes.addFlashAttribute("successMessage", "월간보고가 등록되었습니다.");
    ...
    public String update(@PathVariable Long id,
        ...
        redirectAttributes.addFlashAttribute("successMessage", "월간보고가 수정되었습니다.");
        return "redirect:/monthly-report/" + id;
    }
    ...
    public String delete(@PathVariable Long id, HttpSession session, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("successMessage", "월간보고가 삭제되었습니다.");
        return "redirect:/monthly-report";
    }
