...
public class ArchiveController {
    ...
    private static final String COMMUNITY_TYPE = "자료실";
    private static final String ACTIVE_PAGE    = "community-archive-list";
    ...
    public String create(@Valid @ModelAttribute("community") CommunityDto dto,
        ...
        redirectAttributes.addFlashAttribute("successMessage", "자료가 등록되었습니다.");
    ...
    public String update(@PathVariable Long id,
        ...
        redirectAttributes.addFlashAttribute("successMessage", "자료가 수정되었습니다.");
    ...
    public String delete(@PathVariable Long id, HttpSession session, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("successMessage", "자료가 삭제되었습니다.");
        return "redirect:/archive";
    }
