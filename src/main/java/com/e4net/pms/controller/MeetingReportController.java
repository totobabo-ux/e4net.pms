...
public class MeetingReportController {
    ...
    public String list(@ModelAttribute("search") CustomerReportSearchDto search,
        ...
        search.setAllowedTypes(List.of("회의록"));
    ...
    public String create(@ModelAttribute("report") CustomerReportDto dto,
        ...
        redirectAttributes.addFlashAttribute("successMessage", "회의록이 등록되었습니다.");
        return "redirect:/meeting-report";
    }
    ...
    public String update(@PathVariable Long id,
        ...
        redirectAttributes.addFlashAttribute("successMessage", "회의록이 수정되었습니다.");
        return "redirect:/meeting-report/" + id;
    }
    ...
    public String delete(@PathVariable Long id, HttpSession session, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("successMessage", "회의록이 삭제되었습니다.");
        return "redirect:/meeting-report";
    }
